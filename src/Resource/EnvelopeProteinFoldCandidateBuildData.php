...
readonly class EnvelopeProteinFoldCandidateBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ProteinFoldCandidateBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeProteinFoldCandidateBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ProteinFoldCandidateBuildData::fromArray($data['data']) : null,
