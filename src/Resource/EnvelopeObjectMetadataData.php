...
readonly class EnvelopeObjectMetadataData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectMetadataData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectMetadataData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectMetadataData::fromArray($data['data']) : null,
