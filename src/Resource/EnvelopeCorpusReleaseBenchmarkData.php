...
readonly class EnvelopeCorpusReleaseBenchmarkData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CorpuReleaseBenchmarkData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCorpusReleaseBenchmarkData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CorpuReleaseBenchmarkData::fromArray($data['data']) : null,
