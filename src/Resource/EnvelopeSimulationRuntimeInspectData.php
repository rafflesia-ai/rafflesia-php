...
readonly class EnvelopeSimulationRuntimeInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationRuntimeInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationRuntimeInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationRuntimeInspectData::fromArray($data['data']) : null,
