...
readonly class EnvelopeStructurePreparedInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?StructurePreparedInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeStructurePreparedInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? StructurePreparedInspectData::fromArray($data['data']) : null,
