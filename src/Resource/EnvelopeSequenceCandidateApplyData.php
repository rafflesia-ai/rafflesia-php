...
readonly class EnvelopeSequenceCandidateApplyData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceCandidateApplyData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceCandidateApplyData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceCandidateApplyData::fromArray($data['data']) : null,
