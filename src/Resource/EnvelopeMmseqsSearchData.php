...
readonly class EnvelopeMmseqsSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MmseqSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMmseqsSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MmseqSearchData::fromArray($data['data']) : null,
