...
readonly class EnvelopeHomologyDatabaseReleaseList implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?HomologyDatabaseReleaseList $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeHomologyDatabaseReleaseList::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? HomologyDatabaseReleaseList::fromArray($data['data']) : null,
