...
readonly class EnvelopeMapModelAssociationData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MapModelAssociationData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMapModelAssociationData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MapModelAssociationData::fromArray($data['data']) : null,
