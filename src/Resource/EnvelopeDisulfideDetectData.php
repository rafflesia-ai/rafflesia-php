...
readonly class EnvelopeDisulfideDetectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DisulfideDetectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDisulfideDetectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DisulfideDetectData::fromArray($data['data']) : null,
