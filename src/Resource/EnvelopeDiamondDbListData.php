...
readonly class EnvelopeDiamondDbListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DiamondDbListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDiamondDbListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DiamondDbListData::fromArray($data['data']) : null,
