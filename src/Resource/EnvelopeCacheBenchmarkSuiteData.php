...
readonly class EnvelopeCacheBenchmarkSuiteData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CacheBenchmarkSuiteData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCacheBenchmarkSuiteData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CacheBenchmarkSuiteData::fromArray($data['data']) : null,
