...
readonly class EnvelopeOntologyPathListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyPathListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyPathListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyPathListData::fromArray($data['data']) : null,
