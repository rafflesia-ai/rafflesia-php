...
readonly class EnvelopeFoldSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSearchData::fromArray($data['data']) : null,
