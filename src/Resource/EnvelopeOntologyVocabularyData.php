...
readonly class EnvelopeOntologyVocabularyData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyVocabularyData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyVocabularyData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyVocabularyData::fromArray($data['data']) : null,
