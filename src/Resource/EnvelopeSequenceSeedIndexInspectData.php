...
readonly class EnvelopeSequenceSeedIndexInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceSeedIndexInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceSeedIndexInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceSeedIndexInspectData::fromArray($data['data']) : null,
