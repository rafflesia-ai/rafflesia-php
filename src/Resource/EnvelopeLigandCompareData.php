...
readonly class EnvelopeLigandCompareData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?LigandCompareData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeLigandCompareData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? LigandCompareData::fromArray($data['data']) : null,
