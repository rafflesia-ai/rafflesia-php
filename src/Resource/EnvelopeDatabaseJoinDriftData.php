...
readonly class EnvelopeDatabaseJoinDriftData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatabaseJoinDriftData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatabaseJoinDriftData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatabaseJoinDriftData::fromArray($data['data']) : null,
