...
readonly class EnvelopeCacheExplainData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CacheExplainData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCacheExplainData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CacheExplainData::fromArray($data['data']) : null,
