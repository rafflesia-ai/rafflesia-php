...
readonly class EnvelopeFoldIndexMaterializeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldIndexMaterializeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldIndexMaterializeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldIndexMaterializeData::fromArray($data['data']) : null,
