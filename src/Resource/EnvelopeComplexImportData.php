...
readonly class EnvelopeComplexImportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ComplexImportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeComplexImportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ComplexImportData::fromArray($data['data']) : null,
