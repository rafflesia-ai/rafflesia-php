...
readonly class EnvelopeVariantMapData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?VariantMapData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeVariantMapData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? VariantMapData::fromArray($data['data']) : null,
