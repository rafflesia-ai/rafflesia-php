...
readonly class EnvelopeDatasetCompareData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetCompareData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetCompareData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetCompareData::fromArray($data['data']) : null,
