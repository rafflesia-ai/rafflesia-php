...
readonly class EnvelopeBlastDbDescribeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BlastDbDescribeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBlastDbDescribeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BlastDbDescribeData::fromArray($data['data']) : null,
