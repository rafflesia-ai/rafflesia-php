...
readonly class EnvelopeRqlCompilationData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RqlCompilationData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRqlCompilationData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RqlCompilationData::fromArray($data['data']) : null,
