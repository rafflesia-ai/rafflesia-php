...
readonly class EnvelopeApiKeyListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ApiKeyListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeApiKeyListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ApiKeyListData::fromArray($data['data']) : null,
