...
readonly class EnvelopeSequenceCandidateSweepData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceCandidateSweepData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceCandidateSweepData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceCandidateSweepData::fromArray($data['data']) : null,
