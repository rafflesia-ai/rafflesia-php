...
readonly class EnvelopeObjectArtifactContractData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectArtifactContractData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectArtifactContractData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectArtifactContractData::fromArray($data['data']) : null,
