...
readonly class EnvelopeResidueFeaturesData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ResidueFeaturesData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeResidueFeaturesData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ResidueFeaturesData::fromArray($data['data']) : null,
