...
readonly class EnvelopeDatasetSourceSnapshotImportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetSourceSnapshotImportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetSourceSnapshotImportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetSourceSnapshotImportData::fromArray($data['data']) : null,
