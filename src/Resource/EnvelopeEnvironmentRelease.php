...
readonly class EnvelopeEnvironmentRelease implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?EnvironmentRelease $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeEnvironmentRelease::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? EnvironmentRelease::fromArray($data['data']) : null,
