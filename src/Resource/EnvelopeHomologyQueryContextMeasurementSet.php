...
readonly class EnvelopeHomologyQueryContextMeasurementSet implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?HomologyQueryContextMeasurementSet $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeHomologyQueryContextMeasurementSet::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? HomologyQueryContextMeasurementSet::fromArray($data['data']) : null,
