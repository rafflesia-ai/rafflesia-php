...
readonly class EnvelopeRqlModuleListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RqlModuleListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRqlModuleListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RqlModuleListData::fromArray($data['data']) : null,
