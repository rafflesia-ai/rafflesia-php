...
readonly class ExecutionEnvelopeWebhookDelivery implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?WebhookDelivery $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeWebhookDelivery::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? WebhookDelivery::fromArray($data['data']) : null,
