...
readonly class EnvelopeFoldSegmentBenchmarkData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSegmentBenchmarkData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSegmentBenchmarkData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSegmentBenchmarkData::fromArray($data['data']) : null,
