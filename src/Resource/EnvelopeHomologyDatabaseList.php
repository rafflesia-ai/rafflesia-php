...
readonly class EnvelopeHomologyDatabaseList implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?HomologyDatabaseList $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeHomologyDatabaseList::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? HomologyDatabaseList::fromArray($data['data']) : null,
