...
readonly class LigandNeighborsRequest implements \JsonSerializable
{
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for LigandNeighborsRequest::fromArray()");
            }
        }
        return new self(
            ...
            maxNeighbors: $data['max_neighbors'] ?? null,
    ...
    public function toArray(): array
    {
        return [
            ...
            'max_neighbors' => $this->maxNeighbors,
