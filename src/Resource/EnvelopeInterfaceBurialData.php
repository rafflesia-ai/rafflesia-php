...
readonly class EnvelopeInterfaceBurialData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?InterfaceBurialData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeInterfaceBurialData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? InterfaceBurialData::fromArray($data['data']) : null,
