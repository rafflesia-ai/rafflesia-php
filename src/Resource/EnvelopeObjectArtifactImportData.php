...
readonly class EnvelopeObjectArtifactImportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectArtifactImportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectArtifactImportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectArtifactImportData::fromArray($data['data']) : null,
