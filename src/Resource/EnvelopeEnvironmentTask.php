...
readonly class EnvelopeEnvironmentTask implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?EnvironmentTask $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeEnvironmentTask::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? EnvironmentTask::fromArray($data['data']) : null,
