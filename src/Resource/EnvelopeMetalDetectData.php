...
readonly class EnvelopeMetalDetectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MetalDetectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMetalDetectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MetalDetectData::fromArray($data['data']) : null,
