...
readonly class EnvelopeJoinEvidenceListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?JoinEvidenceListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeJoinEvidenceListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? JoinEvidenceListData::fromArray($data['data']) : null,
