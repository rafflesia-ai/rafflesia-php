...
readonly class EnvelopeSequenceCandidateGcPlanData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceCandidateGcPlanData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceCandidateGcPlanData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceCandidateGcPlanData::fromArray($data['data']) : null,
