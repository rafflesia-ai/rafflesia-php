...
readonly class EnvelopeGenomeIntervalsIntersectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?GenomeIntervalsIntersectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeGenomeIntervalsIntersectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? GenomeIntervalsIntersectData::fromArray($data['data']) : null,
