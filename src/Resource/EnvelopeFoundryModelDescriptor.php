...
readonly class EnvelopeFoundryModelDescriptor implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoundryModelDescriptor $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoundryModelDescriptor::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoundryModelDescriptor::fromArray($data['data']) : null,
