...
readonly class EnvelopeMoleculeFingerprintsData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MoleculeFingerprintsData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMoleculeFingerprintsData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MoleculeFingerprintsData::fromArray($data['data']) : null,
