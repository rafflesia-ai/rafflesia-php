...
readonly class EnvelopeSqlCredentialListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SqlCredentialListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSqlCredentialListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SqlCredentialListData::fromArray($data['data']) : null,
