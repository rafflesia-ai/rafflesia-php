...
readonly class EnvelopeDiamondDbPublishData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DiamondDbPublishData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDiamondDbPublishData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DiamondDbPublishData::fromArray($data['data']) : null,
