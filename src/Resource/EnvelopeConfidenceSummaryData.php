...
readonly class EnvelopeConfidenceSummaryData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ConfidenceSummaryData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeConfidenceSummaryData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ConfidenceSummaryData::fromArray($data['data']) : null,
