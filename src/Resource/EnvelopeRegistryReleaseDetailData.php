...
readonly class EnvelopeRegistryReleaseDetailData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RegistryReleaseDetailData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRegistryReleaseDetailData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RegistryReleaseDetailData::fromArray($data['data']) : null,
