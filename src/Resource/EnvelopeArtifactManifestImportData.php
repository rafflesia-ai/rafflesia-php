...
readonly class EnvelopeArtifactManifestImportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ArtifactManifestImportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeArtifactManifestImportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ArtifactManifestImportData::fromArray($data['data']) : null,
