...
readonly class EnvelopeAnmFluctuationsData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?AnmFluctuationsData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeAnmFluctuationsData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? AnmFluctuationsData::fromArray($data['data']) : null,
