...
readonly class ExecutionEnvelopeStorageFileList implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?StorageFileList $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeStorageFileList::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? StorageFileList::fromArray($data['data']) : null,
