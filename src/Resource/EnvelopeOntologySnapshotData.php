...
readonly class EnvelopeOntologySnapshotData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologySnapshotData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologySnapshotData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologySnapshotData::fromArray($data['data']) : null,
