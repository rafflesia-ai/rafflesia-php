...
readonly class ExecutionEnvelopeFileUploadPartList implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FileUploadPartList $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeFileUploadPartList::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FileUploadPartList::fromArray($data['data']) : null,
