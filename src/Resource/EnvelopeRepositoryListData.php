...
readonly class EnvelopeRepositoryListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RepositoryListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRepositoryListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RepositoryListData::fromArray($data['data']) : null,
