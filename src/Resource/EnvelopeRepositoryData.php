...
readonly class EnvelopeRepositoryData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RepositoryData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRepositoryData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RepositoryData::fromArray($data['data']) : null,
