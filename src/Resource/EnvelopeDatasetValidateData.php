...
readonly class EnvelopeDatasetValidateData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetValidateData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetValidateData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetValidateData::fromArray($data['data']) : null,
