...
readonly class RunEndpointMetaAiEsm23BInput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointMetaAiEsm23BInputRunEmbeddingInput>|null */
        ...
        public string $layer = 'repr_layer_36',
    ...
    {
        return new self(
            inputs: isset($data['inputs']) ? array_map(fn ($item) => RunEndpointMetaAiEsm23BInputRunEmbeddingInput::fromArray($item), $data['inputs']) : null,
            ...
            layer: $data['layer'] ?? 'repr_layer_36',
