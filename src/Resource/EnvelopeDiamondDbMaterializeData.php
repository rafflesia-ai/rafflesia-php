...
readonly class EnvelopeDiamondDbMaterializeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DiamondDbMaterializeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDiamondDbMaterializeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DiamondDbMaterializeData::fromArray($data['data']) : null,
