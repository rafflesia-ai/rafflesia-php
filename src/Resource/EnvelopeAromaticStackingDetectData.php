...
readonly class EnvelopeAromaticStackingDetectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?AromaticStackingDetectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeAromaticStackingDetectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? AromaticStackingDetectData::fromArray($data['data']) : null,
