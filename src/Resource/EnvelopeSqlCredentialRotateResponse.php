...
readonly class EnvelopeSqlCredentialRotateResponse implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SqlCredentialRotateResponse $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSqlCredentialRotateResponse::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SqlCredentialRotateResponse::fromArray($data['data']) : null,
