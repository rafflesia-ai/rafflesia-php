...
readonly class EnvelopeCryoEmMapData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CryoEmMapData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCryoEmMapData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CryoEmMapData::fromArray($data['data']) : null,
