...
readonly class EnvelopeRelationReleasePublicationData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RelationReleasePublicationData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRelationReleasePublicationData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RelationReleasePublicationData::fromArray($data['data']) : null,
