...
readonly class EnvelopeOntologyConnectivityImpactData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyConnectivityImpactData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyConnectivityImpactData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyConnectivityImpactData::fromArray($data['data']) : null,
