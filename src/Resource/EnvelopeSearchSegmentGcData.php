...
readonly class EnvelopeSearchSegmentGcData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SearchSegmentGcData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSearchSegmentGcData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SearchSegmentGcData::fromArray($data['data']) : null,
