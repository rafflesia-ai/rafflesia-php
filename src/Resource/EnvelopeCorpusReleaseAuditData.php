...
readonly class EnvelopeCorpusReleaseAuditData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CorpuReleaseAuditData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCorpusReleaseAuditData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CorpuReleaseAuditData::fromArray($data['data']) : null,
