...
readonly class EnvelopeAnnotationFetchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?AnnotationFetchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeAnnotationFetchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? AnnotationFetchData::fromArray($data['data']) : null,
