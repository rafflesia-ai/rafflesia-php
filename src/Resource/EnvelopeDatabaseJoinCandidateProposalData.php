...
readonly class EnvelopeDatabaseJoinCandidateProposalData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatabaseJoinCandidateProposalData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatabaseJoinCandidateProposalData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatabaseJoinCandidateProposalData::fromArray($data['data']) : null,
