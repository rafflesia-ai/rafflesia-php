...
readonly class EnvelopeListEnvironment implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ListEnvironment $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeListEnvironment::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ListEnvironment::fromArray($data['data']) : null,
