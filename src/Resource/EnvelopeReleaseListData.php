...
readonly class EnvelopeReleaseListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ReleaseListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeReleaseListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ReleaseListData::fromArray($data['data']) : null,
