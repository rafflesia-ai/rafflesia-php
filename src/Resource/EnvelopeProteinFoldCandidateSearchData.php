...
readonly class EnvelopeProteinFoldCandidateSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ProteinFoldCandidateSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeProteinFoldCandidateSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ProteinFoldCandidateSearchData::fromArray($data['data']) : null,
