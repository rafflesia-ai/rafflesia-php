...
readonly class EnvelopeSimulationGromacsInspectMdpData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationGromacsInspectMdpData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationGromacsInspectMdpData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationGromacsInspectMdpData::fromArray($data['data']) : null,
