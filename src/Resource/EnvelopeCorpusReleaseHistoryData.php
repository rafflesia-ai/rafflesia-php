...
readonly class EnvelopeCorpusReleaseHistoryData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CorpuReleaseHistoryData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCorpusReleaseHistoryData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CorpuReleaseHistoryData::fromArray($data['data']) : null,
