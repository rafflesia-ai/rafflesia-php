...
readonly class EnvelopeStructureAlignData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?StructureAlignData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeStructureAlignData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? StructureAlignData::fromArray($data['data']) : null,
