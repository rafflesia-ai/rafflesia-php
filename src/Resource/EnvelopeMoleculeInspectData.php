...
readonly class EnvelopeMoleculeInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MoleculeInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMoleculeInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MoleculeInspectData::fromArray($data['data']) : null,
