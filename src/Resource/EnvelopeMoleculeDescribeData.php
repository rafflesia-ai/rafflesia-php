...
readonly class EnvelopeMoleculeDescribeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MoleculeDescribeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMoleculeDescribeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MoleculeDescribeData::fromArray($data['data']) : null,
