...
readonly class EnvelopeSimulationNativeContactFractionTableData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationNativeContactFractionTableData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationNativeContactFractionTableData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationNativeContactFractionTableData::fromArray($data['data']) : null,
