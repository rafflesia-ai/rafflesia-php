...
readonly class EnvelopeFoundryModelListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoundryModelListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoundryModelListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoundryModelListData::fromArray($data['data']) : null,
