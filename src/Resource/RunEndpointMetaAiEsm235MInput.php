...
readonly class RunEndpointMetaAiEsm235MInput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointMetaAiEsm235MInputRunEmbeddingInput>|null */
    ...
    {
        return new self(
            inputs: isset($data['inputs']) ? array_map(fn ($item) => RunEndpointMetaAiEsm235MInputRunEmbeddingInput::fromArray($item), $data['inputs']) : null,
