...
readonly class EnvelopeGenomeAssemblyData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?GenomeAssemblyData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeGenomeAssemblyData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? GenomeAssemblyData::fromArray($data['data']) : null,
