...
readonly class EnvelopeSqlCredentialUsageData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SqlCredentialUsageData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSqlCredentialUsageData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SqlCredentialUsageData::fromArray($data['data']) : null,
