...
readonly class ExecutionEnvelopeWebhookEndpointList implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?WebhookEndpointList $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeWebhookEndpointList::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? WebhookEndpointList::fromArray($data['data']) : null,
