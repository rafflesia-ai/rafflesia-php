...
readonly class EnvelopeFoldCollectionBenchmarkData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldCollectionBenchmarkData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldCollectionBenchmarkData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldCollectionBenchmarkData::fromArray($data['data']) : null,
