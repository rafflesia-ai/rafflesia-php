...
readonly class EnvelopeMapModelFitBatchExportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MapModelFitBatchExportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMapModelFitBatchExportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MapModelFitBatchExportData::fromArray($data['data']) : null,
