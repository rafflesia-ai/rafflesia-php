...
readonly class EnvelopeRegistrySnapshotData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RegistrySnapshotData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRegistrySnapshotData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RegistrySnapshotData::fromArray($data['data']) : null,
