...
final class MimeDataCoerce
{
    ...
    public static function coerce(mixed $input, ?HttpClient $client = null): MimeData
    {
        ...
        if (is_array($input)) {
            ...
            throw new \InvalidArgumentException(
                'Cannot coerce array to Rafflesia\\Resource\\MimeData; supply '
        ...
        throw new \InvalidArgumentException(
            'Cannot coerce ' . get_debug_type($input) . ' to Rafflesia\\Resource\\MimeData; '
    ...
    private static function resolveFileId(string $fileId, string $filename, ?HttpClient $client): MimeData
    {
        if ($client === null) {
            throw new \InvalidArgumentException(
                'A file-id document requires a Rafflesia client to resolve a download link; '
