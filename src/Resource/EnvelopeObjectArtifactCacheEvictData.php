...
readonly class EnvelopeObjectArtifactCacheEvictData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectArtifactCacheEvictData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectArtifactCacheEvictData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectArtifactCacheEvictData::fromArray($data['data']) : null,
