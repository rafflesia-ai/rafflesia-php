...
readonly class EnvelopeBlastDbListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BlastDbListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBlastDbListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BlastDbListData::fromArray($data['data']) : null,
