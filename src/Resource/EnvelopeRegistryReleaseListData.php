...
readonly class EnvelopeRegistryReleaseListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RegistryReleaseListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRegistryReleaseListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RegistryReleaseListData::fromArray($data['data']) : null,
