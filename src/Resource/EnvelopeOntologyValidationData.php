...
readonly class EnvelopeOntologyValidationData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyValidationData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyValidationData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyValidationData::fromArray($data['data']) : null,
