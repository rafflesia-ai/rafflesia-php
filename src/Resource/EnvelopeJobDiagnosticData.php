...
readonly class EnvelopeJobDiagnosticData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?JobDiagnosticData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeJobDiagnosticData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? JobDiagnosticData::fromArray($data['data']) : null,
