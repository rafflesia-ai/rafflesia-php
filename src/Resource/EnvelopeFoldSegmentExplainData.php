...
readonly class EnvelopeFoldSegmentExplainData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSegmentExplainData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSegmentExplainData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSegmentExplainData::fromArray($data['data']) : null,
