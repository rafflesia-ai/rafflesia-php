...
readonly class EnvelopeRqlModuleData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RqlModuleData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRqlModuleData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RqlModuleData::fromArray($data['data']) : null,
