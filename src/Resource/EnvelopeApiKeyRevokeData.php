...
readonly class EnvelopeApiKeyRevokeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ApiKeyRevokeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeApiKeyRevokeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ApiKeyRevokeData::fromArray($data['data']) : null,
