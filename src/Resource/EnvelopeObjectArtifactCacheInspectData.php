...
readonly class EnvelopeObjectArtifactCacheInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectArtifactCacheInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectArtifactCacheInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectArtifactCacheInspectData::fromArray($data['data']) : null,
