...
readonly class EnvelopeJobCleanupData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?JobCleanupData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeJobCleanupData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? JobCleanupData::fromArray($data['data']) : null,
