...
readonly class EnvelopeSecondaryStructureData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SecondaryStructureData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSecondaryStructureData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SecondaryStructureData::fromArray($data['data']) : null,
