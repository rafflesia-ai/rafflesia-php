...
readonly class EnvelopeSequenceAlignData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceAlignData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceAlignData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceAlignData::fromArray($data['data']) : null,
