...
readonly class EnvelopeSequenceCatalogBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceCatalogBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceCatalogBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceCatalogBuildData::fromArray($data['data']) : null,
