...
readonly class EnvelopeBiosearchQueryProfileIngestData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BiosearchQueryProfileIngestData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBiosearchQueryProfileIngestData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BiosearchQueryProfileIngestData::fromArray($data['data']) : null,
