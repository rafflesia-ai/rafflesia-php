...
readonly class EnvelopeSequenceSeedIndexPlanData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceSeedIndexPlanData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceSeedIndexPlanData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceSeedIndexPlanData::fromArray($data['data']) : null,
