...
readonly class EnvelopeVariantNormalizeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?VariantNormalizeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeVariantNormalizeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? VariantNormalizeData::fromArray($data['data']) : null,
