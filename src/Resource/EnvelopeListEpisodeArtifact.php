...
readonly class EnvelopeListEpisodeArtifact implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ListEpisodeArtifact $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeListEpisodeArtifact::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ListEpisodeArtifact::fromArray($data['data']) : null,
