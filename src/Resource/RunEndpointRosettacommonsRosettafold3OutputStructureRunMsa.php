...
readonly class RunEndpointRosettacommonsRosettafold3OutputStructureRunMsa implements \JsonSerializable
{
    ...
    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointRosettacommonsRosettafold3OutputStructureRunMsaChain>|null */
        public ?array $chains,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            chains: isset($data['chains']) ? array_map(fn ($item) => RunEndpointRosettacommonsRosettafold3OutputStructureRunMsaChain::fromArray($item), $data['chains']) : null,
