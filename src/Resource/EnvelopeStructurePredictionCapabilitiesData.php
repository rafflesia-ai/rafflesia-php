...
readonly class EnvelopeStructurePredictionCapabilitiesData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?StructurePredictionCapabilitiesData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeStructurePredictionCapabilitiesData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? StructurePredictionCapabilitiesData::fromArray($data['data']) : null,
