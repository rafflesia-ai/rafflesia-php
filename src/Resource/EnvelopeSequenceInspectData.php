...
readonly class EnvelopeSequenceInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceInspectData::fromArray($data['data']) : null,
