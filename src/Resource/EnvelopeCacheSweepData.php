...
readonly class EnvelopeCacheSweepData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CacheSweepData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCacheSweepData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CacheSweepData::fromArray($data['data']) : null,
