...
readonly class ApiError implements \JsonSerializable
{
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ApiError::fromArray()");
            }
        }
        return new self(
            code: $data['code'],
            ...
            type: ApiErrorType::from($data['type']),
