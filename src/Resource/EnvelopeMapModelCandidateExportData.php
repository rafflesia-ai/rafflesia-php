...
readonly class EnvelopeMapModelCandidateExportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MapModelCandidateExportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMapModelCandidateExportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MapModelCandidateExportData::fromArray($data['data']) : null,
