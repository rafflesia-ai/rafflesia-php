...
readonly class EnvelopeDiamondSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DiamondSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDiamondSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DiamondSearchData::fromArray($data['data']) : null,
