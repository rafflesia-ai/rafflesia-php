...
readonly class ExecutionEnvelopeFileSignedUrl implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FileSignedUrl $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeFileSignedUrl::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FileSignedUrl::fromArray($data['data']) : null,
