...
readonly class EnvelopeOntologyVocabularyListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyVocabularyListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyVocabularyListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyVocabularyListData::fromArray($data['data']) : null,
