...
readonly class EnvelopeDatasetSourceSnapshotStatusData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetSourceSnapshotStatusData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetSourceSnapshotStatusData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetSourceSnapshotStatusData::fromArray($data['data']) : null,
