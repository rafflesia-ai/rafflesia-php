...
readonly class EnvelopeOntologySnapshotListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologySnapshotListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologySnapshotListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologySnapshotListData::fromArray($data['data']) : null,
