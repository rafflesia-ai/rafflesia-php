...
readonly class RunEndpointChaidiscoveryChai1OutputStructureRunMsaChain implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public string $url,
        public ?RunEndpointChaidiscoveryChai1OutputMsaMeasurementLink $measurements = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for RunEndpointChaidiscoveryChai1OutputStructureRunMsaChain::fromArray()");
            }
        }
        return new self(
            ...
            url: $data['url'],
            measurements: isset($data['measurements']) ? RunEndpointChaidiscoveryChai1OutputMsaMeasurementLink::fromArray($data['measurements']) : null,
