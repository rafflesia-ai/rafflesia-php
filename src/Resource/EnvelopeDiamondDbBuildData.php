...
readonly class EnvelopeDiamondDbBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DiamondDbBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDiamondDbBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DiamondDbBuildData::fromArray($data['data']) : null,
