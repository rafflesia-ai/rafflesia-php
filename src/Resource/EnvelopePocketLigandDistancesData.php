...
readonly class EnvelopePocketLigandDistancesData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?PocketLigandDistancesData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopePocketLigandDistancesData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? PocketLigandDistancesData::fromArray($data['data']) : null,
