...
readonly class EnvelopeSimulationGromacsInspectScriptData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationGromacsInspectScriptData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationGromacsInspectScriptData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationGromacsInspectScriptData::fromArray($data['data']) : null,
