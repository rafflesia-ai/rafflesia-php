...
readonly class EnvelopeOntologyDiffData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyDiffData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyDiffData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyDiffData::fromArray($data['data']) : null,
