...
readonly class EnvelopeRuntimeReconciliationReceipt implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RuntimeReconciliationReceipt $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRuntimeReconciliationReceipt::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RuntimeReconciliationReceipt::fromArray($data['data']) : null,
