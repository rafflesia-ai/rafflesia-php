...
readonly class EnvelopeListEnvironmentTask implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ListEnvironmentTask $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeListEnvironmentTask::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ListEnvironmentTask::fromArray($data['data']) : null,
