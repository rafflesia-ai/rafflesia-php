...
readonly class EnvelopeCorpusReleasePublishCurrentData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CorpuReleasePublishCurrentData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCorpusReleasePublishCurrentData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CorpuReleasePublishCurrentData::fromArray($data['data']) : null,
