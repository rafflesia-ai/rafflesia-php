...
readonly class EnvelopeMountUpsertData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MountUpsertData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMountUpsertData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MountUpsertData::fromArray($data['data']) : null,
