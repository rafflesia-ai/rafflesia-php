...
readonly class EnvelopeProfileBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ProfileBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeProfileBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ProfileBuildData::fromArray($data['data']) : null,
