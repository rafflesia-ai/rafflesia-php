...
readonly class RunEndpointMetaAiEsm215BInput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointMetaAiEsm215BInputRunEmbeddingInput>|null */
        ...
        public string $layer = 'repr_layer_48',
    ...
    {
        return new self(
            inputs: isset($data['inputs']) ? array_map(fn ($item) => RunEndpointMetaAiEsm215BInputRunEmbeddingInput::fromArray($item), $data['inputs']) : null,
            ...
            layer: $data['layer'] ?? 'repr_layer_48',
