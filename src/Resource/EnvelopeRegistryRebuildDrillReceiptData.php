...
readonly class EnvelopeRegistryRebuildDrillReceiptData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RegistryRebuildDrillReceiptData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRegistryRebuildDrillReceiptData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RegistryRebuildDrillReceiptData::fromArray($data['data']) : null,
