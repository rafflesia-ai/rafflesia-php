...
readonly class EnvelopeObjectHeadData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectHeadData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectHeadData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectHeadData::fromArray($data['data']) : null,
