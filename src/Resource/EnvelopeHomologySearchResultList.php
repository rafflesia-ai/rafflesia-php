...
readonly class EnvelopeHomologySearchResultList implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?HomologySearchResultList $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeHomologySearchResultList::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? HomologySearchResultList::fromArray($data['data']) : null,
