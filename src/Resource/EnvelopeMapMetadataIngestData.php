...
readonly class EnvelopeMapMetadataIngestData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MapMetadataIngestData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMapMetadataIngestData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MapMetadataIngestData::fromArray($data['data']) : null,
