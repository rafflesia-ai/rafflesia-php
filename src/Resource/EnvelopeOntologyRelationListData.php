...
readonly class EnvelopeOntologyRelationListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyRelationListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyRelationListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyRelationListData::fromArray($data['data']) : null,
