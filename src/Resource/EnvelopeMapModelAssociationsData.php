...
readonly class EnvelopeMapModelAssociationsData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MapModelAssociationsData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMapModelAssociationsData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MapModelAssociationsData::fromArray($data['data']) : null,
