...
readonly class EnvelopeOnboardingStatusListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OnboardingStatusListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOnboardingStatusListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OnboardingStatusListData::fromArray($data['data']) : null,
