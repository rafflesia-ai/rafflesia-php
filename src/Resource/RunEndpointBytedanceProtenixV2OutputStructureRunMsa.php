...
readonly class RunEndpointBytedanceProtenixV2OutputStructureRunMsa implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointBytedanceProtenixV2OutputStructureRunMsaChain>|null */
        public ?array $chains,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for RunEndpointBytedanceProtenixV2OutputStructureRunMsa::fromArray()");
            }
        }
        return new self(
            chains: isset($data['chains']) ? array_map(fn ($item) => RunEndpointBytedanceProtenixV2OutputStructureRunMsaChain::fromArray($item), $data['chains']) : null,
