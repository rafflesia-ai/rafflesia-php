...
readonly class RunEndpointMetaAiEsm2150MInput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointMetaAiEsm2150MInputRunEmbeddingInput>|null */
        ...
        public string $layer = 'repr_layer_30',
    ...
    {
        return new self(
            inputs: isset($data['inputs']) ? array_map(fn ($item) => RunEndpointMetaAiEsm2150MInputRunEmbeddingInput::fromArray($item), $data['inputs']) : null,
            ...
            layer: $data['layer'] ?? 'repr_layer_30',
