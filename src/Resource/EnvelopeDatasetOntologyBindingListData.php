...
readonly class EnvelopeDatasetOntologyBindingListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetOntologyBindingListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetOntologyBindingListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetOntologyBindingListData::fromArray($data['data']) : null,
