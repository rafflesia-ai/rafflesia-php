...
readonly class EnvelopeAuditLogListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?AuditLogListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeAuditLogListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? AuditLogListData::fromArray($data['data']) : null,
