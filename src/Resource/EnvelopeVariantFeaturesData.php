...
readonly class EnvelopeVariantFeaturesData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?VariantFeaturesData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeVariantFeaturesData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? VariantFeaturesData::fromArray($data['data']) : null,
