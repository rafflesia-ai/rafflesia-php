...
readonly class EnvelopeMsaFromSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MsaFromSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMsaFromSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MsaFromSearchData::fromArray($data['data']) : null,
