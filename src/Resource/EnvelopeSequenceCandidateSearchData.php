...
readonly class EnvelopeSequenceCandidateSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceCandidateSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceCandidateSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceCandidateSearchData::fromArray($data['data']) : null,
