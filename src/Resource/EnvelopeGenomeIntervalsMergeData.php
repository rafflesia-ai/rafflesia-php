...
readonly class EnvelopeGenomeIntervalsMergeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?GenomeIntervalsMergeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeGenomeIntervalsMergeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? GenomeIntervalsMergeData::fromArray($data['data']) : null,
