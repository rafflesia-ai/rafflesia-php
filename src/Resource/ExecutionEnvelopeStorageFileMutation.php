...
readonly class ExecutionEnvelopeStorageFileMutation implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?StorageFileMutation $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeStorageFileMutation::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? StorageFileMutation::fromArray($data['data']) : null,
