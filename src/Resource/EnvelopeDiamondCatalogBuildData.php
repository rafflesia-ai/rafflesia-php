...
readonly class EnvelopeDiamondCatalogBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DiamondCatalogBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDiamondCatalogBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DiamondCatalogBuildData::fromArray($data['data']) : null,
