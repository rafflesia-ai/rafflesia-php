...
readonly class EnvelopeMapModelFitCandidateSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MapModelFitCandidateSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMapModelFitCandidateSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MapModelFitCandidateSearchData::fromArray($data['data']) : null,
