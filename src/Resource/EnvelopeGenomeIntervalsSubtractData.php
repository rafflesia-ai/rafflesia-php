...
readonly class EnvelopeGenomeIntervalsSubtractData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?GenomeIntervalsSubtractData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeGenomeIntervalsSubtractData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? GenomeIntervalsSubtractData::fromArray($data['data']) : null,
