...
readonly class EnvelopeArchiveInventoryData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ArchiveInventoryData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeArchiveInventoryData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ArchiveInventoryData::fromArray($data['data']) : null,
