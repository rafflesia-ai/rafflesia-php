...
readonly class EnvelopeFoldSegmentCompactData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSegmentCompactData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSegmentCompactData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSegmentCompactData::fromArray($data['data']) : null,
