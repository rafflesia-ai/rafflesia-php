...
readonly class EnvelopeDatasetSourceSnapshotProfileListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetSourceSnapshotProfileListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetSourceSnapshotProfileListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetSourceSnapshotProfileListData::fromArray($data['data']) : null,
