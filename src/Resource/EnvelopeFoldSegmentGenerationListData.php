...
readonly class EnvelopeFoldSegmentGenerationListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSegmentGenerationListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSegmentGenerationListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSegmentGenerationListData::fromArray($data['data']) : null,
