...
readonly class EnvelopeSqlCredentialCreateResponse implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SqlCredentialCreateResponse $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSqlCredentialCreateResponse::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SqlCredentialCreateResponse::fromArray($data['data']) : null,
