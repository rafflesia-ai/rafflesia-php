...
readonly class EnvelopeFoundryEmbeddingData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoundryEmbeddingData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoundryEmbeddingData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoundryEmbeddingData::fromArray($data['data']) : null,
