...
readonly class EnvelopeDiamondDbVerifyData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DiamondDbVerifyData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDiamondDbVerifyData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DiamondDbVerifyData::fromArray($data['data']) : null,
