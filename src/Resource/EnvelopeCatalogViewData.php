...
readonly class EnvelopeCatalogViewData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CatalogViewData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCatalogViewData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CatalogViewData::fromArray($data['data']) : null,
