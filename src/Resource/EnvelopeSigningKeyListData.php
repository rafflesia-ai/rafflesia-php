...
readonly class EnvelopeSigningKeyListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SigningKeyListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSigningKeyListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SigningKeyListData::fromArray($data['data']) : null,
