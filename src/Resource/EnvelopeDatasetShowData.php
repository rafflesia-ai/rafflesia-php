...
readonly class EnvelopeDatasetShowData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetShowData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetShowData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetShowData::fromArray($data['data']) : null,
