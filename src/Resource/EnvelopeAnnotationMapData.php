...
readonly class EnvelopeAnnotationMapData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?AnnotationMapData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeAnnotationMapData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? AnnotationMapData::fromArray($data['data']) : null,
