...
readonly class EnvelopeBlastSearchBenchmarkData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BlastSearchBenchmarkData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBlastSearchBenchmarkData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BlastSearchBenchmarkData::fromArray($data['data']) : null,
