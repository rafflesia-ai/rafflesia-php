...
readonly class EnvelopeJobEventListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?JobEventListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeJobEventListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? JobEventListData::fromArray($data['data']) : null,
