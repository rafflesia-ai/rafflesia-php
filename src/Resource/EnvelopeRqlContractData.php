...
readonly class EnvelopeRqlContractData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RqlContractData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRqlContractData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RqlContractData::fromArray($data['data']) : null,
