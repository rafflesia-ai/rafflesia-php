...
readonly class EnvelopeFoldIndexListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldIndexListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldIndexListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldIndexListData::fromArray($data['data']) : null,
