...
readonly class EnvelopeBiosearchQueryProfileAuditRunData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BiosearchQueryProfileAuditRunData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBiosearchQueryProfileAuditRunData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BiosearchQueryProfileAuditRunData::fromArray($data['data']) : null,
