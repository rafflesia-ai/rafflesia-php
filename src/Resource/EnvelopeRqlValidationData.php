...
readonly class EnvelopeRqlValidationData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RqlValidationData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRqlValidationData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RqlValidationData::fromArray($data['data']) : null,
