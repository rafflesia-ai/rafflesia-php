...
readonly class EnvelopeSearchSegmentPrefetchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SearchSegmentPrefetchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSearchSegmentPrefetchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SearchSegmentPrefetchData::fromArray($data['data']) : null,
