...
readonly class EnvelopeTrustedSigningKey implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?TrustedSigningKey $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeTrustedSigningKey::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? TrustedSigningKey::fromArray($data['data']) : null,
