...
readonly class EnvelopeStructurePrepareData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?StructurePrepareData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeStructurePrepareData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? StructurePrepareData::fromArray($data['data']) : null,
