...
readonly class EnvelopeObjectHashData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectHashData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectHashData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectHashData::fromArray($data['data']) : null,
