...
readonly class EnvelopeDiamondDbEvictData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DiamondDbEvictData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDiamondDbEvictData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DiamondDbEvictData::fromArray($data['data']) : null,
