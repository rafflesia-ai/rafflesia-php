...
readonly class EnvelopeVariantQueryData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?VariantQueryData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeVariantQueryData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? VariantQueryData::fromArray($data['data']) : null,
