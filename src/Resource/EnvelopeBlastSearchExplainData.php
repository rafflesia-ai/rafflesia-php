...
readonly class EnvelopeBlastSearchExplainData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BlastSearchExplainData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBlastSearchExplainData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BlastSearchExplainData::fromArray($data['data']) : null,
