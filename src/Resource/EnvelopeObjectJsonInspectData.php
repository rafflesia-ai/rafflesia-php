...
readonly class EnvelopeObjectJsonInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectJsonInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectJsonInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectJsonInspectData::fromArray($data['data']) : null,
