...
readonly class EnvelopeBlastDbMaterializeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BlastDbMaterializeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBlastDbMaterializeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BlastDbMaterializeData::fromArray($data['data']) : null,
