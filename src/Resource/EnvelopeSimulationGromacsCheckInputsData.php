...
readonly class EnvelopeSimulationGromacsCheckInputsData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationGromacsCheckInputsData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationGromacsCheckInputsData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationGromacsCheckInputsData::fromArray($data['data']) : null,
