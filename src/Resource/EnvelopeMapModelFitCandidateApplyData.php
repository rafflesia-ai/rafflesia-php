...
readonly class EnvelopeMapModelFitCandidateApplyData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MapModelFitCandidateApplyData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMapModelFitCandidateApplyData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MapModelFitCandidateApplyData::fromArray($data['data']) : null,
