...
readonly class EnvelopeFoldSegmentGcData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSegmentGcData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSegmentGcData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSegmentGcData::fromArray($data['data']) : null,
