...
readonly class EnvelopeQueryExportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?QueryExportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeQueryExportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? QueryExportData::fromArray($data['data']) : null,
