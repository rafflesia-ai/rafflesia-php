...
readonly class EnvelopeFoldCollectionPublishData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldCollectionPublishData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldCollectionPublishData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldCollectionPublishData::fromArray($data['data']) : null,
