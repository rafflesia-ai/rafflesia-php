...
readonly class EnvelopeOntologyRelationshipData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyRelationshipData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyRelationshipData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyRelationshipData::fromArray($data['data']) : null,
