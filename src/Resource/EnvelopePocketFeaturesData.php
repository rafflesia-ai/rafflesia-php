...
readonly class EnvelopePocketFeaturesData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?PocketFeaturesData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopePocketFeaturesData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? PocketFeaturesData::fromArray($data['data']) : null,
