...
readonly class EnvelopeJoinApprovalListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?JoinApprovalListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeJoinApprovalListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? JoinApprovalListData::fromArray($data['data']) : null,
