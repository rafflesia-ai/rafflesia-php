...
readonly class EnvelopeOntologyConnectivityRebuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyConnectivityRebuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyConnectivityRebuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyConnectivityRebuildData::fromArray($data['data']) : null,
