...
readonly class EnvelopeTargetResolveData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?TargetResolveData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeTargetResolveData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? TargetResolveData::fromArray($data['data']) : null,
