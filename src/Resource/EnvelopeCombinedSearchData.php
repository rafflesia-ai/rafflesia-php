...
readonly class EnvelopeCombinedSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CombinedSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCombinedSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CombinedSearchData::fromArray($data['data']) : null,
