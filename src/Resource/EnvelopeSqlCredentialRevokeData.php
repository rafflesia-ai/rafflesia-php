...
readonly class EnvelopeSqlCredentialRevokeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SqlCredentialRevokeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSqlCredentialRevokeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SqlCredentialRevokeData::fromArray($data['data']) : null,
