...
readonly class EnvelopeRelationReleaseListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RelationReleaseListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRelationReleaseListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RelationReleaseListData::fromArray($data['data']) : null,
