...
readonly class RunEndpointBiohubEsmc6BInput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointBiohubEsmc6BInputRunEmbeddingInput>|null */
    ...
    {
        return new self(
            inputs: isset($data['inputs']) ? array_map(fn ($item) => RunEndpointBiohubEsmc6BInputRunEmbeddingInput::fromArray($item), $data['inputs']) : null,
