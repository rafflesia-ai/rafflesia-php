...
readonly class EnvelopeFoldSegmentGenerationData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSegmentGenerationData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSegmentGenerationData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSegmentGenerationData::fromArray($data['data']) : null,
