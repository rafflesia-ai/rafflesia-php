...
readonly class EnvelopeListEnvironmentRelease implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ListEnvironmentRelease $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeListEnvironmentRelease::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ListEnvironmentRelease::fromArray($data['data']) : null,
