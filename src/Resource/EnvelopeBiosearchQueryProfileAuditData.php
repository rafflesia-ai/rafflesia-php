...
readonly class EnvelopeBiosearchQueryProfileAuditData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BiosearchQueryProfileAuditData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBiosearchQueryProfileAuditData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BiosearchQueryProfileAuditData::fromArray($data['data']) : null,
