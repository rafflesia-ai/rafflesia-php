...
readonly class EnvelopeSimulationContactsTableData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationContactsTableData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationContactsTableData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationContactsTableData::fromArray($data['data']) : null,
