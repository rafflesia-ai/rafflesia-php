...
readonly class EnvelopeSimulationTrajectoryRmsdTableData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationTrajectoryRmsdTableData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationTrajectoryRmsdTableData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationTrajectoryRmsdTableData::fromArray($data['data']) : null,
