...
readonly class EnvelopeFoldIndexDescribeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldIndexDescribeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldIndexDescribeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldIndexDescribeData::fromArray($data['data']) : null,
