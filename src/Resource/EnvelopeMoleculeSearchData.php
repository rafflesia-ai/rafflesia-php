...
readonly class EnvelopeMoleculeSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MoleculeSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMoleculeSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MoleculeSearchData::fromArray($data['data']) : null,
