...
readonly class EnvelopeDatasetSourceSnapshotIngestData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetSourceSnapshotIngestData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetSourceSnapshotIngestData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetSourceSnapshotIngestData::fromArray($data['data']) : null,
