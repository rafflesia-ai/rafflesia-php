...
readonly class EnvelopeDatabaseJoinNormalizationMeasurementData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatabaseJoinNormalizationMeasurementData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatabaseJoinNormalizationMeasurementData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatabaseJoinNormalizationMeasurementData::fromArray($data['data']) : null,
