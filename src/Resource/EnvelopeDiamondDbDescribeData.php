...
readonly class EnvelopeDiamondDbDescribeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DiamondDbDescribeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDiamondDbDescribeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DiamondDbDescribeData::fromArray($data['data']) : null,
