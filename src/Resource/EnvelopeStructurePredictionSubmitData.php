...
readonly class EnvelopeStructurePredictionSubmitData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?StructurePredictionSubmitData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeStructurePredictionSubmitData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? StructurePredictionSubmitData::fromArray($data['data']) : null,
