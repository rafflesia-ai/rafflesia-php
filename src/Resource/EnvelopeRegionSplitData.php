...
readonly class EnvelopeRegionSplitData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RegionSplitData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRegionSplitData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RegionSplitData::fromArray($data['data']) : null,
