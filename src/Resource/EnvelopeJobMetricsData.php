...
readonly class EnvelopeJobMetricsData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?JobMetricsData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeJobMetricsData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? JobMetricsData::fromArray($data['data']) : null,
