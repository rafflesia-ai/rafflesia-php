...
readonly class ExecutionEnvelopeExecutionErrorData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ExecutionErrorData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeExecutionErrorData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ExecutionErrorData::fromArray($data['data']) : null,
