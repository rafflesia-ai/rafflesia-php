...
readonly class EnvelopeRelationListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RelationListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRelationListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RelationListData::fromArray($data['data']) : null,
