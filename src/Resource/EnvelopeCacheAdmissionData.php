...
readonly class EnvelopeCacheAdmissionData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CacheAdmissionData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCacheAdmissionData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CacheAdmissionData::fromArray($data['data']) : null,
