...
readonly class EnvelopeFoundryVariantEffectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoundryVariantEffectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoundryVariantEffectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoundryVariantEffectData::fromArray($data['data']) : null,
