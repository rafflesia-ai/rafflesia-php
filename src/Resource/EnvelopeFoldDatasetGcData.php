...
readonly class EnvelopeFoldDatasetGcData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldDatasetGcData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldDatasetGcData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldDatasetGcData::fromArray($data['data']) : null,
