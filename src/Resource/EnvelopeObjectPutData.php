...
readonly class EnvelopeObjectPutData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectPutData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectPutData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectPutData::fromArray($data['data']) : null,
