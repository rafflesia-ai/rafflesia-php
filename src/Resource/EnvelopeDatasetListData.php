...
readonly class EnvelopeDatasetListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetListData::fromArray($data['data']) : null,
