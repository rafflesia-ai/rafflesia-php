...
readonly class EnvelopeVariantMapGenomicData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?VariantMapGenomicData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeVariantMapGenomicData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? VariantMapGenomicData::fromArray($data['data']) : null,
