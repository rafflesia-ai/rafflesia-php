...
readonly class EnvelopeSimulationTrajectoryInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationTrajectoryInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationTrajectoryInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationTrajectoryInspectData::fromArray($data['data']) : null,
