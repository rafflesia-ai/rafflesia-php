...
readonly class EnvelopeCacheStatusData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CacheStatusData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCacheStatusData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CacheStatusData::fromArray($data['data']) : null,
