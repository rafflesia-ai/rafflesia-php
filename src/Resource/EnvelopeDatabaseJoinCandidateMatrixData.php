...
readonly class EnvelopeDatabaseJoinCandidateMatrixData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatabaseJoinCandidateMatrixData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatabaseJoinCandidateMatrixData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatabaseJoinCandidateMatrixData::fromArray($data['data']) : null,
