...
readonly class EnvelopeTableExportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?TableExportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeTableExportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? TableExportData::fromArray($data['data']) : null,
