...
readonly class EnvelopeStructureAxisProfileData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?StructureAxisProfileData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeStructureAxisProfileData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? StructureAxisProfileData::fromArray($data['data']) : null,
