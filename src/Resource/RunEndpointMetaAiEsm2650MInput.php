...
readonly class RunEndpointMetaAiEsm2650MInput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointMetaAiEsm2650MInputRunEmbeddingInput>|null */
        ...
        public string $layer = 'repr_layer_33',
    ...
    {
        return new self(
            inputs: isset($data['inputs']) ? array_map(fn ($item) => RunEndpointMetaAiEsm2650MInputRunEmbeddingInput::fromArray($item), $data['inputs']) : null,
            ...
            layer: $data['layer'] ?? 'repr_layer_33',
