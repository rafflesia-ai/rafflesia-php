...
readonly class RunEndpointBiohubEsm314BOpenInput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointBiohubEsm314BOpenInputRunEmbeddingInput>|null */
    ...
    {
        return new self(
            inputs: isset($data['inputs']) ? array_map(fn ($item) => RunEndpointBiohubEsm314BOpenInputRunEmbeddingInput::fromArray($item), $data['inputs']) : null,
