...
readonly class EnvelopeArchiveMemberFindData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ArchiveMemberFindData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeArchiveMemberFindData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ArchiveMemberFindData::fromArray($data['data']) : null,
