...
readonly class EnvelopeHmmerSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?HmmerSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeHmmerSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? HmmerSearchData::fromArray($data['data']) : null,
