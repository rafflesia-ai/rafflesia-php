...
readonly class EnvelopeRegistryReconciliationReceiptData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RegistryReconciliationReceiptData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRegistryReconciliationReceiptData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RegistryReconciliationReceiptData::fromArray($data['data']) : null,
