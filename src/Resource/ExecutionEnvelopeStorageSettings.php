...
readonly class ExecutionEnvelopeStorageSettings implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?StorageSettings $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeStorageSettings::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? StorageSettings::fromArray($data['data']) : null,
