...
readonly class EnvelopeFoldSegmentPublishData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSegmentPublishData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSegmentPublishData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSegmentPublishData::fromArray($data['data']) : null,
