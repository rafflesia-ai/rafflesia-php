...
readonly class EnvelopeLocalDistanceDifferenceData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?LocalDistanceDifferenceData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeLocalDistanceDifferenceData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? LocalDistanceDifferenceData::fromArray($data['data']) : null,
