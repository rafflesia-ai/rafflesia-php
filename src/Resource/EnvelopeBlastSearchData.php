...
readonly class EnvelopeBlastSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BlastSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBlastSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BlastSearchData::fromArray($data['data']) : null,
