...
readonly class EnvelopeCorpusReleaseGcPlanData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?CorpuReleaseGcPlanData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeCorpusReleaseGcPlanData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? CorpuReleaseGcPlanData::fromArray($data['data']) : null,
