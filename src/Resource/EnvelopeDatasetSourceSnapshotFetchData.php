...
readonly class EnvelopeDatasetSourceSnapshotFetchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetSourceSnapshotFetchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetSourceSnapshotFetchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetSourceSnapshotFetchData::fromArray($data['data']) : null,
