...
readonly class HmmerCatalogSearchRequest implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?HmmerCatalogSearchRequestProgram $program = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for HmmerCatalogSearchRequest::fromArray()");
            }
        }
        return new self(
            ...
            program: isset($data['program']) ? HmmerCatalogSearchRequestProgram::from($data['program']) : null,
