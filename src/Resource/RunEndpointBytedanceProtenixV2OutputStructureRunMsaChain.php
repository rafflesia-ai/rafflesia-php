...
readonly class RunEndpointBytedanceProtenixV2OutputStructureRunMsaChain implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public string $url,
        public ?RunEndpointBytedanceProtenixV2OutputMsaMeasurementLink $measurements = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for RunEndpointBytedanceProtenixV2OutputStructureRunMsaChain::fromArray()");
            }
        }
        return new self(
            ...
            url: $data['url'],
            measurements: isset($data['measurements']) ? RunEndpointBytedanceProtenixV2OutputMsaMeasurementLink::fromArray($data['measurements']) : null,
