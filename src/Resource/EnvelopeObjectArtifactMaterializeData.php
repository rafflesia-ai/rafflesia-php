...
readonly class EnvelopeObjectArtifactMaterializeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectArtifactMaterializeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectArtifactMaterializeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectArtifactMaterializeData::fromArray($data['data']) : null,
