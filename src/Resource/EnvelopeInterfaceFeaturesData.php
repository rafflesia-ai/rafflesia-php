...
readonly class EnvelopeInterfaceFeaturesData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?InterfaceFeaturesData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeInterfaceFeaturesData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? InterfaceFeaturesData::fromArray($data['data']) : null,
