...
readonly class EnvelopeSequenceCandidateInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceCandidateInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceCandidateInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceCandidateInspectData::fromArray($data['data']) : null,
