...
readonly class EnvelopeSimulationGromacsRunStageData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationGromacsRunStageData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationGromacsRunStageData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationGromacsRunStageData::fromArray($data['data']) : null,
