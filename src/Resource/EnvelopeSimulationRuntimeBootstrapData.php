...
readonly class EnvelopeSimulationRuntimeBootstrapData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationRuntimeBootstrapData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationRuntimeBootstrapData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationRuntimeBootstrapData::fromArray($data['data']) : null,
