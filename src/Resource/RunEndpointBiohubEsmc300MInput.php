...
readonly class RunEndpointBiohubEsmc300MInput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointBiohubEsmc300MInputRunEmbeddingInput>|null */
    ...
    {
        return new self(
            inputs: isset($data['inputs']) ? array_map(fn ($item) => RunEndpointBiohubEsmc300MInputRunEmbeddingInput::fromArray($item), $data['inputs']) : null,
