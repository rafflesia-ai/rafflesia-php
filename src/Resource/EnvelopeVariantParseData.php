...
readonly class EnvelopeVariantParseData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?VariantParseData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeVariantParseData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? VariantParseData::fromArray($data['data']) : null,
