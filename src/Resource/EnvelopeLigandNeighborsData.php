...
readonly class EnvelopeLigandNeighborsData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?LigandNeighborsData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeLigandNeighborsData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? LigandNeighborsData::fromArray($data['data']) : null,
