...
readonly class EnvelopeArtifactMaterializeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ArtifactMaterializeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeArtifactMaterializeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ArtifactMaterializeData::fromArray($data['data']) : null,
