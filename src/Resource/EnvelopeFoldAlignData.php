...
readonly class EnvelopeFoldAlignData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldAlignData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldAlignData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldAlignData::fromArray($data['data']) : null,
