...
readonly class EnvelopeMountListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MountListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMountListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MountListData::fromArray($data['data']) : null,
