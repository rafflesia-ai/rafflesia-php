...
readonly class RunEndpointMetaAiEsm215BOutput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointMetaAiEsm215BOutputEmbeddingVector>|null */
         ...
         * @var array<\Rafflesia\Resource\RunEndpointMetaAiEsm215BOutputEmbeddingSegment>|null
         */
        public ?array $segments = null,
        public ?RunEndpointMetaAiEsm215BOutputEmbeddingUsage $usage = null,
    ...
    {
        return new self(
            data: isset($data['data']) ? array_map(fn ($item) => RunEndpointMetaAiEsm215BOutputEmbeddingVector::fromArray($item), $data['data']) : null,
            ...
            segments: isset($data['segments']) ? array_map(fn ($item) => RunEndpointMetaAiEsm215BOutputEmbeddingSegment::fromArray($item), $data['segments']) : null,
            usage: isset($data['usage']) ? RunEndpointMetaAiEsm215BOutputEmbeddingUsage::fromArray($data['usage']) : null,
