...
readonly class EnvelopeObjectJsonGetData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectJsonGetData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectJsonGetData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectJsonGetData::fromArray($data['data']) : null,
