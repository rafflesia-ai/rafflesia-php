...
readonly class EnvelopeSearchSegmentBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SearchSegmentBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSearchSegmentBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SearchSegmentBuildData::fromArray($data['data']) : null,
