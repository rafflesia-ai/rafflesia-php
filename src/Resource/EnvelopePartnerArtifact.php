...
readonly class EnvelopePartnerArtifact implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?PartnerArtifact $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopePartnerArtifact::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? PartnerArtifact::fromArray($data['data']) : null,
