...
readonly class ExecutionEnvelopeWebhookDeliveryList implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?WebhookDeliveryList $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeWebhookDeliveryList::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? WebhookDeliveryList::fromArray($data['data']) : null,
