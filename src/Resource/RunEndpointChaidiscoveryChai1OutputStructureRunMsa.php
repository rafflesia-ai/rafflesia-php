...
readonly class RunEndpointChaidiscoveryChai1OutputStructureRunMsa implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointChaidiscoveryChai1OutputStructureRunMsaChain>|null */
        public ?array $chains,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for RunEndpointChaidiscoveryChai1OutputStructureRunMsa::fromArray()");
            }
        }
        return new self(
            chains: isset($data['chains']) ? array_map(fn ($item) => RunEndpointChaidiscoveryChai1OutputStructureRunMsaChain::fromArray($item), $data['chains']) : null,
