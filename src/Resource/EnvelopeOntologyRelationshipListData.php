...
readonly class EnvelopeOntologyRelationshipListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyRelationshipListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyRelationshipListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyRelationshipListData::fromArray($data['data']) : null,
