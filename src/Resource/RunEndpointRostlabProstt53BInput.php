...
readonly class RunEndpointRostlabProstt53BInput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointRostlabProstt53BInputRunEmbeddingInput>|null */
        public ?array $inputs,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for RunEndpointRostlabProstt53BInput::fromArray()");
            }
        }
        return new self(
            inputs: isset($data['inputs']) ? array_map(fn ($item) => RunEndpointRostlabProstt53BInputRunEmbeddingInput::fromArray($item), $data['inputs']) : null,
