...
readonly class EnvelopeSimulationTrajectoryGeometryTableData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationTrajectoryGeometryTableData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationTrajectoryGeometryTableData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationTrajectoryGeometryTableData::fromArray($data['data']) : null,
