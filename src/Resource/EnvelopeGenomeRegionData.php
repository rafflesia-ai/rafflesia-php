...
readonly class EnvelopeGenomeRegionData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?GenomeRegionData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeGenomeRegionData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? GenomeRegionData::fromArray($data['data']) : null,
