...
readonly class EnvelopeMapModelFitScoreData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MapModelFitScoreData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMapModelFitScoreData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MapModelFitScoreData::fromArray($data['data']) : null,
