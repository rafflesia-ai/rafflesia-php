...
readonly class EnvelopeObjectLineageData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectLineageData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectLineageData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectLineageData::fromArray($data['data']) : null,
