...
readonly class EnvelopeSequenceSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceSearchData::fromArray($data['data']) : null,
