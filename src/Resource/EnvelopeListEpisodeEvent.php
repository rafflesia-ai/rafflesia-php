...
readonly class EnvelopeListEpisodeEvent implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ListEpisodeEvent $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeListEpisodeEvent::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ListEpisodeEvent::fromArray($data['data']) : null,
