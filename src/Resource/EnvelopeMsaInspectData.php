...
readonly class EnvelopeMsaInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MsaInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMsaInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MsaInspectData::fromArray($data['data']) : null,
