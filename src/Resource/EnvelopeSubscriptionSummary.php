...
readonly class EnvelopeSubscriptionSummary implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SubscriptionSummary $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSubscriptionSummary::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SubscriptionSummary::fromArray($data['data']) : null,
