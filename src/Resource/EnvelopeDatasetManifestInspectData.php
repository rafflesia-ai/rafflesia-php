...
readonly class EnvelopeDatasetManifestInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetManifestInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetManifestInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetManifestInspectData::fromArray($data['data']) : null,
