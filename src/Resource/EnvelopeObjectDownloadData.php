...
readonly class EnvelopeObjectDownloadData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ObjectDownloadData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeObjectDownloadData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ObjectDownloadData::fromArray($data['data']) : null,
