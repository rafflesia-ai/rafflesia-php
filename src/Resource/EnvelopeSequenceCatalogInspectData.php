...
readonly class EnvelopeSequenceCatalogInspectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceCatalogInspectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceCatalogInspectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceCatalogInspectData::fromArray($data['data']) : null,
