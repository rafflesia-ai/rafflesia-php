...
readonly class EnvelopeDatabaseJoinCertificationData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatabaseJoinCertificationData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatabaseJoinCertificationData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatabaseJoinCertificationData::fromArray($data['data']) : null,
