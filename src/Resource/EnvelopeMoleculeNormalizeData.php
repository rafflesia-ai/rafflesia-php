...
readonly class EnvelopeMoleculeNormalizeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MoleculeNormalizeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMoleculeNormalizeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MoleculeNormalizeData::fromArray($data['data']) : null,
