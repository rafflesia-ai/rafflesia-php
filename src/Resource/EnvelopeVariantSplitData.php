...
readonly class EnvelopeVariantSplitData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?VariantSplitData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeVariantSplitData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? VariantSplitData::fromArray($data['data']) : null,
