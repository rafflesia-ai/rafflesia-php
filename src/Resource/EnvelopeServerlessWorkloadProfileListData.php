...
readonly class EnvelopeServerlessWorkloadProfileListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ServerlessWorkloadProfileListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeServerlessWorkloadProfileListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ServerlessWorkloadProfileListData::fromArray($data['data']) : null,
