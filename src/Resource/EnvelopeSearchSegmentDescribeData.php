...
readonly class EnvelopeSearchSegmentDescribeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SearchSegmentDescribeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSearchSegmentDescribeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SearchSegmentDescribeData::fromArray($data['data']) : null,
