...
readonly class EnvelopeQueryContractData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?QueryContractData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeQueryContractData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? QueryContractData::fromArray($data['data']) : null,
