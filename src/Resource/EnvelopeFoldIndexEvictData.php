...
readonly class EnvelopeFoldIndexEvictData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldIndexEvictData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldIndexEvictData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldIndexEvictData::fromArray($data['data']) : null,
