...
readonly class EnvelopeFoldSearchBenchmarkData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSearchBenchmarkData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSearchBenchmarkData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSearchBenchmarkData::fromArray($data['data']) : null,
