...
readonly class EnvelopeFoldCollectionGcData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldCollectionGcData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldCollectionGcData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldCollectionGcData::fromArray($data['data']) : null,
