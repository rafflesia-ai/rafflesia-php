...
readonly class EnvelopeApiKeyCreateResponse implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ApiKeyCreateResponse $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeApiKeyCreateResponse::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ApiKeyCreateResponse::fromArray($data['data']) : null,
