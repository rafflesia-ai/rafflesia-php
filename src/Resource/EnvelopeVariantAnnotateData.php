...
readonly class EnvelopeVariantAnnotateData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?VariantAnnotateData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeVariantAnnotateData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? VariantAnnotateData::fromArray($data['data']) : null,
