...
readonly class EnvelopeFoldSegmentSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSegmentSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSegmentSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSegmentSearchData::fromArray($data['data']) : null,
