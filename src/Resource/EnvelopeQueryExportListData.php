...
readonly class EnvelopeQueryExportListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?QueryExportListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeQueryExportListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? QueryExportListData::fromArray($data['data']) : null,
