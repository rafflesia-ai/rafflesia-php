...
readonly class EnvelopeRelationDescriptor implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RelationDescriptor $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRelationDescriptor::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RelationDescriptor::fromArray($data['data']) : null,
