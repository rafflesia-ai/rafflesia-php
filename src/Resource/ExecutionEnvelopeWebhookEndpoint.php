...
readonly class ExecutionEnvelopeWebhookEndpoint implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?WebhookEndpoint $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeWebhookEndpoint::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? WebhookEndpoint::fromArray($data['data']) : null,
