...
readonly class EnvelopeMoleculeImportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MoleculeImportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMoleculeImportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MoleculeImportData::fromArray($data['data']) : null,
