...
readonly class EnvelopeFoldCollectionSearchData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldCollectionSearchData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldCollectionSearchData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldCollectionSearchData::fromArray($data['data']) : null,
