...
readonly class EnvelopePlatformIndexData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?PlatformIndexData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopePlatformIndexData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? PlatformIndexData::fromArray($data['data']) : null,
