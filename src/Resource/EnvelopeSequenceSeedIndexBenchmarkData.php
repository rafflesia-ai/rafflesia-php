...
readonly class EnvelopeSequenceSeedIndexBenchmarkData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceSeedIndexBenchmarkData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceSeedIndexBenchmarkData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceSeedIndexBenchmarkData::fromArray($data['data']) : null,
