...
readonly class EnvelopeFoldIndexBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldIndexBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldIndexBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldIndexBuildData::fromArray($data['data']) : null,
