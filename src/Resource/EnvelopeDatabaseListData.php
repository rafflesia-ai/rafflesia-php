...
readonly class EnvelopeDatabaseListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatabaseListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatabaseListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatabaseListData::fromArray($data['data']) : null,
