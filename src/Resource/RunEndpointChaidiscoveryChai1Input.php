...
readonly class RunEndpointChaidiscoveryChai1Input implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointChaidiscoveryChai1InputStructurePredictionEntity>|null */
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for RunEndpointChaidiscoveryChai1Input::fromArray()");
            }
        }
        return new self(
            entities: isset($data['entities']) ? array_map(fn ($item) => RunEndpointChaidiscoveryChai1InputStructurePredictionEntity::fromArray($item), $data['entities']) : null,
