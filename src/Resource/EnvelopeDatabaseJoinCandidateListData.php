...
readonly class EnvelopeDatabaseJoinCandidateListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatabaseJoinCandidateListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatabaseJoinCandidateListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatabaseJoinCandidateListData::fromArray($data['data']) : null,
