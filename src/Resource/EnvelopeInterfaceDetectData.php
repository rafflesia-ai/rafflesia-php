...
readonly class EnvelopeInterfaceDetectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?InterfaceDetectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeInterfaceDetectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? InterfaceDetectData::fromArray($data['data']) : null,
