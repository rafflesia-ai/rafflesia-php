...
readonly class EnvelopeSimulationTrajectoryFramesTableData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationTrajectoryFramesTableData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationTrajectoryFramesTableData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationTrajectoryFramesTableData::fromArray($data['data']) : null,
