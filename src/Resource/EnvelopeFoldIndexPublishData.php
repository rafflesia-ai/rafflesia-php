...
readonly class EnvelopeFoldIndexPublishData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldIndexPublishData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldIndexPublishData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldIndexPublishData::fromArray($data['data']) : null,
