...
readonly class EnvelopeDatasetManifestScanData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetManifestScanData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetManifestScanData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetManifestScanData::fromArray($data['data']) : null,
