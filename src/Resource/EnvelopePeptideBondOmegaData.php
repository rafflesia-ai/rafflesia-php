...
readonly class EnvelopePeptideBondOmegaData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?PeptideBondOmegaData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopePeptideBondOmegaData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? PeptideBondOmegaData::fromArray($data['data']) : null,
