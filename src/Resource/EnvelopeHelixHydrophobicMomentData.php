...
readonly class EnvelopeHelixHydrophobicMomentData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?HelixHydrophobicMomentData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeHelixHydrophobicMomentData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? HelixHydrophobicMomentData::fromArray($data['data']) : null,
