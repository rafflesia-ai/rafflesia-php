...
readonly class EnvelopeFoldSegmentBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldSegmentBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldSegmentBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldSegmentBuildData::fromArray($data['data']) : null,
