...
readonly class EnvelopeSearchSegmentPlanData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SearchSegmentPlanData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSearchSegmentPlanData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SearchSegmentPlanData::fromArray($data['data']) : null,
