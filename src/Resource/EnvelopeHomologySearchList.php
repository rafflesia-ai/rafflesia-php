...
readonly class EnvelopeHomologySearchList implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?HomologySearchList $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeHomologySearchList::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? HomologySearchList::fromArray($data['data']) : null,
