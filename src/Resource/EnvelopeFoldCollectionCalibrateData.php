...
readonly class EnvelopeFoldCollectionCalibrateData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoldCollectionCalibrateData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoldCollectionCalibrateData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoldCollectionCalibrateData::fromArray($data['data']) : null,
