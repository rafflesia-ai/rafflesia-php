...
readonly class EnvelopeResidueRotamersData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ResidueRotamersData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeResidueRotamersData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ResidueRotamersData::fromArray($data['data']) : null,
