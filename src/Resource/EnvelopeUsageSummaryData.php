...
readonly class EnvelopeUsageSummaryData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?UsageSummaryData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeUsageSummaryData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? UsageSummaryData::fromArray($data['data']) : null,
