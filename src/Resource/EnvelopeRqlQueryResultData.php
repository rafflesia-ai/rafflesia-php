...
readonly class EnvelopeRqlQueryResultData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RqlQueryResultData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRqlQueryResultData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RqlQueryResultData::fromArray($data['data']) : null,
