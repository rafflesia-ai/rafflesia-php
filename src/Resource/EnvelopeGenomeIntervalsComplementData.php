...
readonly class EnvelopeGenomeIntervalsComplementData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?GenomeIntervalsComplementData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeGenomeIntervalsComplementData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? GenomeIntervalsComplementData::fromArray($data['data']) : null,
