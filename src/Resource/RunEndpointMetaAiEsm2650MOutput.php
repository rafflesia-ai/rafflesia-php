...
readonly class RunEndpointMetaAiEsm2650MOutput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointMetaAiEsm2650MOutputEmbeddingVector>|null */
         ...
         * @var array<\Rafflesia\Resource\RunEndpointMetaAiEsm2650MOutputEmbeddingSegment>|null
         */
        public ?array $segments = null,
        public ?RunEndpointMetaAiEsm2650MOutputEmbeddingUsage $usage = null,
    ...
    {
        return new self(
            data: isset($data['data']) ? array_map(fn ($item) => RunEndpointMetaAiEsm2650MOutputEmbeddingVector::fromArray($item), $data['data']) : null,
            ...
            segments: isset($data['segments']) ? array_map(fn ($item) => RunEndpointMetaAiEsm2650MOutputEmbeddingSegment::fromArray($item), $data['segments']) : null,
            usage: isset($data['usage']) ? RunEndpointMetaAiEsm2650MOutputEmbeddingUsage::fromArray($data['usage']) : null,
