...
readonly class EnvelopeVariantNearbyData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?VariantNearbyData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeVariantNearbyData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? VariantNearbyData::fromArray($data['data']) : null,
