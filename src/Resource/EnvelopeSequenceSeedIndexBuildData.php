...
readonly class EnvelopeSequenceSeedIndexBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceSeedIndexBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceSeedIndexBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceSeedIndexBuildData::fromArray($data['data']) : null,
