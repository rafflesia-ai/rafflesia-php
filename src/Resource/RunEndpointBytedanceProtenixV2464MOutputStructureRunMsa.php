...
readonly class RunEndpointBytedanceProtenixV2464MOutputStructureRunMsa implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public string $url,
        public ?RunEndpointBytedanceProtenixV2464MOutputMsaMeasurementLink $measurements = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for RunEndpointBytedanceProtenixV2464MOutputStructureRunMsa::fromArray()");
            }
        }
        return new self(
            ...
            url: $data['url'],
            measurements: isset($data['measurements']) ? RunEndpointBytedanceProtenixV2464MOutputMsaMeasurementLink::fromArray($data['measurements']) : null,
