...
readonly class EnvelopeSimulationGromacsMaterializeInputsData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationGromacsMaterializeInputsData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationGromacsMaterializeInputsData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationGromacsMaterializeInputsData::fromArray($data['data']) : null,
