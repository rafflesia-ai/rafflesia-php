...
readonly class EnvelopeOntologyReleaseCoverageData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyReleaseCoverageData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyReleaseCoverageData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyReleaseCoverageData::fromArray($data['data']) : null,
