...
readonly class EnvelopeOntologyOnboardingCompileData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?OntologyOnboardingCompileData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeOntologyOnboardingCompileData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? OntologyOnboardingCompileData::fromArray($data['data']) : null,
