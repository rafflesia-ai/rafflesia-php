...
readonly class EnvelopeBillingHostedSession implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BillingHostedSession $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBillingHostedSession::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BillingHostedSession::fromArray($data['data']) : null,
