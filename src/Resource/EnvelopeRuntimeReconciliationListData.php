...
readonly class EnvelopeRuntimeReconciliationListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RuntimeReconciliationListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRuntimeReconciliationListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RuntimeReconciliationListData::fromArray($data['data']) : null,
