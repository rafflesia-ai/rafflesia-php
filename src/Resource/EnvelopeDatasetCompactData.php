...
readonly class EnvelopeDatasetCompactData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?DatasetCompactData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeDatasetCompactData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? DatasetCompactData::fromArray($data['data']) : null,
