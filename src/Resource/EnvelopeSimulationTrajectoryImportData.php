...
readonly class EnvelopeSimulationTrajectoryImportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SimulationTrajectoryImportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSimulationTrajectoryImportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SimulationTrajectoryImportData::fromArray($data['data']) : null,
