...
readonly class EnvelopeArchiveArtifactImportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ArchiveArtifactImportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeArchiveArtifactImportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ArchiveArtifactImportData::fromArray($data['data']) : null,
