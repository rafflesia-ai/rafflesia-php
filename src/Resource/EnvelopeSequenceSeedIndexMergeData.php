...
readonly class EnvelopeSequenceSeedIndexMergeData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SequenceSeedIndexMergeData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeSequenceSeedIndexMergeData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? SequenceSeedIndexMergeData::fromArray($data['data']) : null,
