...
readonly class EnvelopeRqlFormatData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RqlFormatData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRqlFormatData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RqlFormatData::fromArray($data['data']) : null,
