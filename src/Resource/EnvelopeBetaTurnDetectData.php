...
readonly class EnvelopeBetaTurnDetectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BetaTurnDetectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBetaTurnDetectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BetaTurnDetectData::fromArray($data['data']) : null,
