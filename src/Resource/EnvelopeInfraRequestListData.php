...
readonly class EnvelopeInfraRequestListData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?InfraRequestListData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeInfraRequestListData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? InfraRequestListData::fromArray($data['data']) : null,
