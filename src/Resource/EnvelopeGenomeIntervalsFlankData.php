...
readonly class EnvelopeGenomeIntervalsFlankData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?GenomeIntervalsFlankData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeGenomeIntervalsFlankData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? GenomeIntervalsFlankData::fromArray($data['data']) : null,
