...
readonly class EnvelopeListRolloutGroup implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?ListRolloutGroup $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeListRolloutGroup::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? ListRolloutGroup::fromArray($data['data']) : null,
