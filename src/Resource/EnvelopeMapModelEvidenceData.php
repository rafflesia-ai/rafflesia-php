...
readonly class EnvelopeMapModelEvidenceData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?MapModelEvidenceData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeMapModelEvidenceData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? MapModelEvidenceData::fromArray($data['data']) : null,
