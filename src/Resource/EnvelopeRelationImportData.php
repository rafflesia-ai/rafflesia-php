...
readonly class EnvelopeRelationImportData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?RelationImportData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeRelationImportData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? RelationImportData::fromArray($data['data']) : null,
