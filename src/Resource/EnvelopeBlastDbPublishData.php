...
readonly class EnvelopeBlastDbPublishData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BlastDbPublishData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBlastDbPublishData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BlastDbPublishData::fromArray($data['data']) : null,
