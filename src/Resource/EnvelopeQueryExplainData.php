...
readonly class EnvelopeQueryExplainData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?QueryExplainData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeQueryExplainData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? QueryExplainData::fromArray($data['data']) : null,
