...
readonly class EnvelopeBlastDbBuildData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BlastDbBuildData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBlastDbBuildData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BlastDbBuildData::fromArray($data['data']) : null,
