...
readonly class RunEndpointBiohubEsmc600MOutput implements \JsonSerializable
{
    use JsonSerializableTrait;

    public function __construct(
        /** @var array<\Rafflesia\Resource\RunEndpointBiohubEsmc600MOutputEmbeddingVector>|null */
         ...
         * @var array<\Rafflesia\Resource\RunEndpointBiohubEsmc600MOutputEmbeddingSegment>|null
         */
        public ?array $segments = null,
        public ?RunEndpointBiohubEsmc600MOutputEmbeddingUsage $usage = null,
    ...
    {
        return new self(
            data: isset($data['data']) ? array_map(fn ($item) => RunEndpointBiohubEsmc600MOutputEmbeddingVector::fromArray($item), $data['data']) : null,
            ...
            segments: isset($data['segments']) ? array_map(fn ($item) => RunEndpointBiohubEsmc600MOutputEmbeddingSegment::fromArray($item), $data['segments']) : null,
            usage: isset($data['usage']) ? RunEndpointBiohubEsmc600MOutputEmbeddingUsage::fromArray($data['usage']) : null,
