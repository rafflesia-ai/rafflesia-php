...
readonly class EnvelopeBlastDbVerifyData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?BlastDbVerifyData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeBlastDbVerifyData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? BlastDbVerifyData::fromArray($data['data']) : null,
