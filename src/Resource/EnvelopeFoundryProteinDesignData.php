...
readonly class EnvelopeFoundryProteinDesignData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FoundryProteinDesignData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopeFoundryProteinDesignData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FoundryProteinDesignData::fromArray($data['data']) : null,
