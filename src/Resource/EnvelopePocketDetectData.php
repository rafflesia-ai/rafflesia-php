...
readonly class EnvelopePocketDetectData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?PocketDetectData $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for EnvelopePocketDetectData::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? PocketDetectData::fromArray($data['data']) : null,
