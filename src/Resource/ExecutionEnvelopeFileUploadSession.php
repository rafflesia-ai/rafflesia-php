...
readonly class ExecutionEnvelopeFileUploadSession implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FileUploadSession $data = null,
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for ExecutionEnvelopeFileUploadSession::fromArray()");
            }
        }
        return new self(
            ok: $data['ok'],
            ...
            data: isset($data['data']) ? FileUploadSession::fromArray($data['data']) : null,
